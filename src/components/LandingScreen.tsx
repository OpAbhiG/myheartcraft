...
export default function LandingScreen({
  ...
  const faqs = [
    ...
    {
      q: "Is MyHeartCraft free to create and share?",
      a: "Yes! MyHeartCraft is 100% free to design, customize, and share unlimited digital gift surprises for your loved ones."
    }
  ];
    ...
    <div className="bg-surface text-on-surface font-body-md antialiased overflow-x-hidden relative flex flex-col min-h-screen" id="landing-page">
      ...
      <header className="bg-background/95 backdrop-blur-md border-b border-primary/20 sticky top-0 flex justify-between items-center px-4 md:px-16 w-full z-50 h-20 transition-all duration-300" id="topAppBar">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <span className="font-display-lg text-xl md:text-2xl font-black tracking-tighter uppercase italic text-primary">MyHeartCraft</span>
        </div>
      ...
      <footer className="bg-surface-container border-t border-primary/20 text-on-surface py-14 px-6 md:px-16 w-full relative z-10 mt-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              ...
              <span className="font-display-lg font-black text-lg tracking-wider uppercase italic text-primary">MyHeartCraft</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto pt-10 mt-10 border-t border-primary/10 flex flex-col sm:flex-row justify-between items-center text-[10px] uppercase tracking-[0.15em] font-mono text-on-surface-variant/70">
          <div>© 2026 MyHeartCraft. All rights reserved.</div>
          ...
          <div className="bg-background border border-primary p-6 md:p-10 w-full max-w-2xl relative shadow-2xl max-h-[85vh] overflow-y-auto">
            ...
            {activeModal === 'about' && (
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-primary">
                  ...
                  <h3 className="font-display-lg text-2xl font-light text-on-background">Know About Us — MyHeartCraft</h3>
                </div>
                <p className="text-xs text-on-surface-variant leading-relaxed font-body-lg">
                  MyHeartCraft was born from a simple belief: in a world dominated by instant messages and temporary social posts, true emotion deserves a permanent, beautiful form.
                </p>
                <p className="text-xs text-on-surface-variant leading-relaxed font-body-lg">
            ...
            {activeModal === 'privacy' && (
              <div className="space-y-4">
                ...
                <div className="text-xs text-on-surface-variant leading-relaxed space-y-3 font-body-lg">
                  <p><strong>1. Information Collection & Storage:</strong> MyHeartCraft prioritizes user privacy. Creations built on our platform are stored on the creator's local device and rendered through unique encoded URL payloads.</p>
            ...
            {activeModal === 'terms' && (
              <div className="space-y-4">
                ...
                <div className="text-xs text-on-surface-variant leading-relaxed space-y-3 font-body-lg">
                  <p><strong>1. Acceptance of Terms:</strong> By creating or viewing experiences on MyHeartCraft, you agree to comply with these terms of use.</p>
