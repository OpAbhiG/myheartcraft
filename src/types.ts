...
export const TEMPLATE_EXPERIENCES: ExperienceTemplate[] = [
  ...
  },
  {
    ...
    description: 'An intimate, vintage parchment envelope experience with a wax seal that breaks open to reveal your deepest feelings and photo memories.',
  ...
  },
  {
    ...
    description: 'Walk through your years together in a beautifully curated digital photo gallery with soothing piano ambiances.',
    duration: '10 mins',
